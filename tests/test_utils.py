...
class TestUtils:
    ...
    def test_compute_pairwise_iou_empty_lists(self):
    ...
    def test_compute_pairwise_iou_non_overlapping(self):
    ...
    def test_compute_pairwise_iou_overlapping(self):
    ...
    def test_find_best_matches_no_matches(self):
    ...
    def test_find_best_matches_with_matches(self):
